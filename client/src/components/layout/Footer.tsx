          ...
          <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-8 place-items-center w-full">
            <div className='w-full'>
              ...
              <ul className="space-y-2 text-black">
                <li><a href="#" className="hover:font-bold transition-colors">Wishlist</a></li>
                <li><a href="#" className="hover:font-bold transition-colors">Support</a></li>
                <li><a href="#" className="hover:font-bold transition-colors">Status</a></li>
                <li><a href="#" className="hover:font-bold transition-colors">Forum</a></li>
                <li><a href="#" className="hover:font-bold transition-colors">Articles</a></li>
              </ul>
            </div>
            <div className='w-full'>
              <h4 className="font-bold text-lg mb-4">Product</h4>
              <ul className="space-y-2 text-black">
                <li><a href="#" className="hover:font-bold transition-colors">Templates</a></li>
                <li><a href="#" className="hover:font-bold transition-colors">Pricing</a></li>
                <li><a href="#" className="hover:font-bold transition-colors">Integrations</a></li>
                <li><a href="#" className="hover:font-bold transition-colors">Security</a></li>
                <li><a href="#" className="hover:font-bold transition-colors">Accessibility</a></li>
              </ul>
            </div>
            <div className='w-full'>
              <h4 className="font-bold text-lg mb-4">Resources</h4>
              <ul className="space-y-2 text-black">
                <li><a href="#" className="hover:font-bold transition-colors">Documentation</a></li>
                <li><a href="#" className="hover:font-bold transition-colors">API Reference</a></li>
                <li><a href="#" className="hover:font-bold transition-colors">Blog</a></li>
                <li><a href="#" className="hover:font-bold transition-colors">Resources</a></li>
                <li><a href="#" className="hover:font-bold transition-colors">Stuff</a></li>
              </ul>
            </div>
            <div className='w-full'>
              <h4 className="font-bold text-lg mb-4">Company</h4>
              <ul className="space-y-2 text-black">
                <li><a href="#" className="hover:font-bold transition-colors">About</a></li>
                <li><a href="#" className="hover:font-bold transition-colors">Contact</a></li>
                <li><a href="#" className="hover:font-bold transition-colors">Careers</a></li>
                <li><a href="#" className="hover:font-bold transition-colors">Company</a></li>
                <li><a href="#" className="hover:font-bold transition-colors">Stuff</a></li>
              </ul>
            </div>
            <div className='w-full'>
              ...
              <ul className="space-y-2 text-black">
                <li><a href="#" className="hover:font-bold transition-colors">Become an Expert</a></li>
                <li><a href="#" className="hover:font-bold transition-colors">Become a Designer</a></li>
                <li><a href="#" className="hover:font-bold transition-colors">Become an Affiliate</a></li>
                <li><a href="#" className="hover:font-bold transition-colors">Cookie Policy</a></li>
                <li><a href="#" className="hover:font-bold transition-colors">Cookie Preferences</a></li>
              </ul>
            </div>
            <div className='w-full xl:w-auto'>
              ...
              <ul className="space-y-2 flex flex-col xl:items-end  text-black">
                ...
                <li>
                  <a href="#" className="hover:font-bold transition-colors">
                    <svg fill="none" className='h-6' viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" xmlns="http://www.w3.org/2000/svg">
